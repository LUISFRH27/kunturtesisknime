...
public class PCA extends Scores{
    ...
    public double[] getSumOfRelevantSquares(){
    	double[] communalityWeights = new double[this.nItems];
    	double[][] loadingFactorMatrix = new double[this.nItems][this.nItems];
        for(int i = 0; i<this.nItems; i++)loadingFactorMatrix[i] = this.loadingFactorsAsRows[i];
    	 for(int i = 0; i<nItems; i++){
             communalityWeights[i] = 0.0;
             for(int j = 0; j<nItems; j++)communalityWeights[i] +=  loadingFactorMatrix[j][i]*loadingFactorMatrix[j][i];
         }
        return communalityWeights;
    }
    ...
    public double[][] getRotatedLoadingFactorsAsRows(){return this.rotatedLoadingFactorsAsRows;}
