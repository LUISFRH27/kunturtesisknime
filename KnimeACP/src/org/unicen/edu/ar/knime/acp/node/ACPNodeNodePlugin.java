 ...
 * @author Rodrigo
 */
public class ACPNodeNodePlugin extends Plugin {

    /** Make sure that this *always* matches the ID in plugin.xml. */
    public static final String PLUGIN_ID = "org.unicen.knime.acp";

    // The shared instance.
    private static ACPNodeNodePlugin plugin;

    /**
     * The constructor.
     */
    public ACPNodeNodePlugin() {
        super();
        plugin = this;
    }
     ...
     */
    public static ACPNodeNodePlugin getDefault() {
        return plugin;
    }
